...
"%JAVA_HOME%%JDKBIN%\java.exe" -Djava.library.path="%JAVA_HOME%%JREBIN%" -cp "%JAVA_HOME%\lib\tools.jar;warmroast.jar" com.sk89q.warmroast.WarmRoast --thread "Server thread" -m .\conf %*